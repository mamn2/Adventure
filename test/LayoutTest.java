...
public class LayoutTest {
    ...
    public void getStartingRoomTest() throws AssertionError {
        ...
        Room matthewsStreet = siebelAdventureGame.getGameLayout().createNewRoom();
        matthewsStreet.setName("MatthewsStreet");
        matthewsStreet.setDescription("You are on Matthews, outside the Siebel Center");

        Direction matthewsStreetDirections = matthewsStreet.createNewDirection();
        ...
        matthewsStreet.setPossibleDirections(new Direction[] { matthewsStreetDirections });
    ...
    public void getEndingRoomTest() throws AssertionError {
        ...
        Room siebel1314 = siebelAdventureGame.getGameLayout().createNewRoom();
        ...
        Direction siebel1314Directions = siebel1314.createNewDirection();
        ...
        siebel1314.setPossibleDirections(new Direction[] { siebel1314Directions });
